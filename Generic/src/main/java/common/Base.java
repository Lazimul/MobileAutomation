...
public class Base {
    ...
    @BeforeMethod
    public void setUp(@Optional("android") String OS, @Optional("Phone") String appType,@Optional("Emulator") String deviceType, @Optional("Nexus 6 API 27") String deviceName,
                    @Optional("8.1") String version)throws IOException,InterruptedException{

        if(OS.equalsIgnoreCase("ios")){
            if(appType.contains("iPhone")){
                appDirectory = new File("/Users/lazimulhaque/Downloads/MobileNov2018-master/UiCatalog/src/app/UICatalog6.1.app.zip");
            ...
            if(appType.contains("Phone")){
                appDirectory = new File("/Users/lazimulhaque/Downloads/MobileNov2018-master/ebay/src/app/com.ebay.mobile_2018-11-21.apk");
